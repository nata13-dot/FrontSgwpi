...
<nav class="sidebar">
    ...
    <?php endif; ?>
    <?php if (is_admin()): ?>
        <div style="padding: 0 20px; margin-bottom: 20px;"><h6 class="text-muted text-uppercase" style="font-size: 0.85rem;">Administración</h6></div>
        ...
        <a href="/pages/admin/users.php" class="sidebar-item <?= $current_page == 'users.php' ? 'active' : '' ?>"><i class="bi bi-people"></i><span>Usuarios</span></a>
        <a href="/pages/admin/projects.php" class="sidebar-item <?= $current_page == 'projects.php' ? 'active' : '' ?>"><i class="bi bi-diagram-3"></i><span>Proyectos</span></a>
        <a href="/pages/admin/advisors.php" class="sidebar-item <?= $current_page == 'advisors.php' ? 'active' : '' ?>"><i class="bi bi-person-check"></i><span>Asesores</span></a>
        <details class="sidebar-group" <?= in_array($current_page, ['proposal-config.php', 'deliverables.php', 'evaluations.php']) ? 'open' : '' ?>>
            <summary><i class="bi bi-grid"></i><span>Procesos clave</span><i class="bi bi-chevron-down ms-auto"></i></summary>
    ...
    <?php else: ?>
        ...
        <a href="/pages/student/proposal-register.php" class="sidebar-item <?= $current_page == 'proposal-register.php' ? 'active' : '' ?>"><i class="bi bi-pencil-square"></i><span>Registrar Proyecto</span></a>
        <a href="/pages/student/my-deliverables.php" class="sidebar-item <?= $current_page == 'my-deliverables.php' ? 'active' : '' ?>"><i class="bi bi-file-earmark"></i><span>Mis Entregables</span></a>
        <a href="/pages/profile.php" class="sidebar-item <?= $current_page == 'profile.php' ? 'active' : '' ?>"><i class="bi bi-person-circle"></i><span>Mi Perfil</span></a>
    <?php endif; ?>
</nav>
