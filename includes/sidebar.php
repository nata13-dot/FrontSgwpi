...
<nav class="sidebar" id="appSidebar">
    ...
    <?php if (is_admin()): ?>
        ...
        <details class="sidebar-group" <?= in_array($current_page, ['projects.php', 'project-create.php', 'project-edit.php', 'proposal-config.php', 'deliverables.php', 'evaluations.php', 'evaluations-archived.php', 'evaluation-documents.php']) ? 'open' : '' ?>>
    ...
    <?php elseif (is_teacher()): ?>
        ...
        <details class="sidebar-group" <?= in_array($current_page, ['my-projects.php', 'proposal-review.php', 'evaluations.php', 'evaluations-archived.php', 'evaluation-documents.php']) ? 'open' : '' ?>>
            <summary><i class="bi bi-mortarboard"></i><span>Proyectos y tesis</span><i class="bi bi-chevron-down ms-auto"></i></summary>
            <a href="/pages/teacher/my-projects.php" class="sidebar-item sidebar-subitem <?= $current_page == 'my-projects.php' ? 'active' : '' ?>"><i class="bi bi-folder2"></i><span>Mis tesis</span></a>
    ...
    <?php else: ?>
        ...
        <details class="sidebar-group" <?= in_array($current_page, ['proposal-register.php', 'evaluation-documents.php']) ? 'open' : '' ?>>
            <summary><i class="bi bi-mortarboard"></i><span>Proyectos y tesis</span><i class="bi bi-chevron-down ms-auto"></i></summary>
            <a href="/pages/student/proposal-register.php" class="sidebar-item sidebar-subitem <?= $current_page == 'proposal-register.php' ? 'active' : '' ?>"><i class="bi bi-pencil-square"></i><span>Registrar tesis</span></a>
            <a href="/pages/evaluation-documents.php" class="sidebar-item sidebar-subitem <?= $current_page == 'evaluation-documents.php' ? 'active' : '' ?>"><i class="bi bi-file-earmark-ppt"></i><span>Documentos de evaluación</span></a>
        </details>
        <details class="sidebar-group" <?= in_array($current_page, ['my-deliverables.php']) ? 'open' : '' ?>>
            <summary><i class="bi bi-file-earmark"></i><span>Entregables</span><i class="bi bi-chevron-down ms-auto"></i></summary>
